...
public class DashboardAdapterFirebase extends RecyclerView.Adapter<DashboardAdapterFirebase.ViewHolderF> {
    Context context;
    ArrayList<Item> items;
    String identifier;

    public DashboardAdapterFirebase(Context context, ArrayList<Item> items, String identifier) {
    ...
    @Override
    public void onBindViewHolder(@NonNull DashboardAdapterFirebase.ViewHolderF holder, int position) {
