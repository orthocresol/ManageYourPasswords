...
public class GeneratorActivityFirebase extends AppCompatActivity {
    ...
    private void buttonListeners() {
        ...
        btn_copy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(GeneratorActivityFirebase.this, "Password Copied", Toast.LENGTH_SHORT).show();
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()){
                    case R.id.generator:
                        return true;
                    case R.id.dashboard:
                        intent = new Intent(GeneratorActivityFirebase.this, VaultActivity.class);
                        startActivity(intent);
                        overridePendingTransition(0, 0);
                        finish();
                        return true;
                    case R.id.settings:
                        intent = new Intent(GeneratorActivityFirebase.this, SettingsActivity.class);
                        startActivity(intent);
                        overridePendingTransition(0, 0);
                        finish();
                        return true;
